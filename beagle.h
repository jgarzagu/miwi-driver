...
#define MUX_BEAGLE_XM() \
	...
	MUX_VAL(CP(MCSPI3_CLK),		(IEN  | PTD | DIS | M1)) /*MIS PINES ###### SPI3_CLK*/\
	MUX_VAL(CP(MCSPI3_SIMO),	(IEN  | PTD | DIS | M1)) /*MIS PINES ###### SPI3_DO*/\
	MUX_VAL(CP(MCSPI3_SOMI),	(IEN  | PTD | DIS | M1)) /*MIS PINES ###### SPI3_DI*/\
	MUX_VAL(CP(MCSPI3_CS0),		(IEN  | PTD | EN  | M1)) /*MIS PINES ###### SPI3_CS0*/\
	MUX_VAL(CP(MCSPI3_CS1),		(IDIS | PTD | EN  | M1)) /*MIS PINES ###### SPI3_CS1*/
